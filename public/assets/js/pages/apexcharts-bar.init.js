...
chartBarColors && (options = {
    ...
    xaxis: {
        categories: ["Expired", "Will Expire", "Active"]
    }
...
chartDatalabelsBarColors && (options = {
    ...
    xaxis: {
        categories: ["Exp", "Will Exp", "Active"]
    },
    yaxis: {
        labels: {
            show: !1
...
chartStackedBar100Colors && (options = {
    series: [{
        name: "Marine Sprite",
        data: [44, 55, 41, 37, 22, 43, 21]
    }, {
...
chartNegativeBarColors && (options = {
    series: [{
        name: "Males",
...
chartBarReversedColors && (options = {
    series: [{
...
document.querySelector("#bar_images") && (chart = new ApexCharts(document.querySelector("#bar_images"), options)).render();
