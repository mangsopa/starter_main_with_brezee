...
chartColumnDatatalabelColors && (options = {
    chart: {
        height: 350,
        type: "bar",
        toolbar: {
    ...
    title: {
        text: "Jumlah request Maintenance (Weekly)",
        floating: !0,
        offsetY: 320,
        align: "center",
        style: {
...
chartColumnStackedColors && (options = {
    series: [{
        name: "PRODUCT A",
...
chartColumnStacked100Colors && (options = {
    series: [{
        name: "PRODUCT A",
...
chartColumnMarkersColors && (options = {
    series: [{
        name: "Actual",
        data: [{
            x: "2011",
...
chartColumnRotateLabelsColors && (options = {
    series: [{
        name: "Servings",
...
chartNagetiveValuesColors && (options = {
    series: [{
        name: "Cash Flow",
...
var arrayData, colors = getChartColorsArray("chart-year"); {
        ...
        chart: {
            ...
            events: {
                dataPointSelection: function (t, e, a) {
                    ...
                    1 === a.selectedDataPoints[0].length && (r.classList.contains("active") || (o.classList.add("chart-quarter-activated"), r.classList.add("active"))), updateQuarterChart(e, "barQuarter"), 0 === a.selectedDataPoints[0].length && (o.classList.remove("chart-quarter-activated"), r.classList.remove("active"))
                },
                updated: function (t) {
...
var optionsQuarter, chartQuarter, ChartQuater = getChartColorsArray("chart-quarter");
ChartQuater && (optionsQuarter = {
    series: [{
        data: []
    }],
    chart: {
...
}, (chartQuarter = new ApexCharts(document.querySelector("#chart-quarter"), optionsQuarter)).render(), chart.addEventListener("dataPointSelection", function (t, e, a) {
    var r = document.querySelector("#chart-quarter"),
        o = document.querySelector("#chart-year");
    1 === a.selectedDataPoints[0].length && (r.classList.contains("active") || (o.classList.add("chart-quarter-activated"), r.classList.add("active"))), updateQuarterChart(e, "barQuarter"), 0 === a.selectedDataPoints[0].length && (o.classList.remove("chart-quarter-activated"), r.classList.remove("active"))
...
var options, chart, chartColumnDistributedColors = getChartColorsArray("column_distributed");
chartColumnDistributedColors && (options = {
    series: [{
