<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ url('/') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="/assets/images/logo/logo-industri.png" alt="" height="22">
            </span>
            <span class="logo-lg">
                <!-- <img src="/assets/images/logo/logo-dark.png" alt="" height="17"> -->
                <img src="/assets/images/logo/logo-industri.png" alt="" height="30">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="{{ url('/') }}" class="logo logo-light">
            ...
            <span class="logo-lg">
                ...
                <img src="/assets/images/logo/logo-industri.png" alt="" height="120">
            </span>
        </a>
