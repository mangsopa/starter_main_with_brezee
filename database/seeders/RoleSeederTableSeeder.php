...
class RoleSeederTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $user = Role::create(['name' => 'Leader']);
        $user = Role::create(['name' => 'Manager']);
        $user = Role::create(['name' => 'Human Resources']);
        $user = Role::create(['name' => 'Programmers']);
        ...
        User::firstWhere('email', 'user@gmail.com')->assignRole('Employee');
    }
}
