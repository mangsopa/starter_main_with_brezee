...
chartLineColors && (chartDom = document.getElementById("chart-line"), myChart = echarts.init(chartDom), (option = {
    grid: {
        left: "0%",
        right: "0%",
        bottom: "0%",
...
}) && "object" == typeof option && option && myChart.setOption(option));
var chartLineStackedColors = getChartColorsArray("chart-line-stacked");
chartLineStackedColors && (chartDom = document.getElementById("chart-line-stacked"), myChart = echarts.init(chartDom), (option = {
    tooltip: {
        trigger: "axis"
    },
    legend: {
...
chartAreaColors && (chartDom = document.getElementById("chart-area"), myChart = echarts.init(chartDom), (option = {
    grid: {
        left: "0%",
        right: "0%",
        bottom: "0%",
...
chartAreaStackedColors && (chartDom = document.getElementById("chart-area-stacked"), myChart = echarts.init(chartDom), (option = {
    tooltip: {
        trigger: "axis",
        axisPointer: {
            type: "cross",
...
chartStepLineColors && (chartDom = document.getElementById("chart-step-line"), myChart = echarts.init(chartDom), (option = {
    tooltip: {
        trigger: "axis"
    },
    legend: {
...
chartLineYColors && (chartDom = document.getElementById("chart-line-y-category"), myChart = echarts.init(chartDom), (option = {
    legend: {
...
chartBarColors && (chartDom = document.getElementById("chart-bar"), myChart = echarts.init(chartDom), (option = {
    grid: {
        left: "0%",
        right: "0%",
        bottom: "0%",
...
chartBarHorizontalColors && (chartDom = document.getElementById("chart-horizontal-bar"), myChart = echarts.init(chartDom), (option = {
    tooltip: {
        trigger: "axis",
        axisPointer: {
            type: "shadow"
...
chartBarStackedColors && (chartDom = document.getElementById("chart-horizontal-bar-stacked"), myChart = echarts.init(chartDom), (option = {
    tooltip: {
        trigger: "axis",
        axisPointer: {
            type: "shadow"
...
chartDoughnutColors && (chartDom = document.getElementById("chart-doughnut"), myChart = echarts.init(chartDom), (option = {
    tooltip: {
        trigger: "item"
    },
    legend: {
...
chartScatterColors && (chartDom = document.getElementById("chart-scatter"), myChart = echarts.init(chartDom), (option = {
    grid: {
        left: "1%",
        right: "0%",
        bottom: "0%",
...
chartCandlestickColors && (chartDom = document.getElementById("chart-candlestick"), myChart = echarts.init(chartDom), (option = {
    grid: {
        left: "1%",
        right: "0%",
        bottom: "0%",
...
chartGraphColors && (chartDom = document.getElementById("chart-graph"), myChart = echarts.init(chartDom), (option = {
    tooltip: {},
...
chartTreemapColors && (chartDom = document.getElementById("chart-treemap"), myChart = echarts.init(chartDom), (option = {
...
var data, chartSunburstColors = getChartColorsArray("chart-sunburst");
chartSunburstColors && (chartDom = document.getElementById("chart-sunburst"), myChart = echarts.init(chartDom), (option = {
...
chartParallelColors && (chartDom = document.getElementById("chart-parallel"), myChart = echarts.init(chartDom), (option = {
    parallelAxis: [{
        dim: 0,
        name: "Price"
    }, {
...
chartSankeyColors && (chartDom = document.getElementById("chart-sankey"), myChart = echarts.init(chartDom), (option = {
...
chartFunnelColors && (chartDom = document.getElementById("chart-funnel"), myChart = echarts.init(chartDom), (option = {
    tooltip: {
        trigger: "item",
        formatter: "{a} <br/>{b} : {c}%"
    },
...
chartGaugeColors && (chartDom = document.getElementById("chart-gauge"), myChart = echarts.init(chartDom), (option = {
    tooltip: {
        formatter: "{a} <br/>{b} : {c}%"
    },
...
var chartDom, myChart, option, chartHeatmapColors = getChartColorsArray("chart-heatmap");

function getVirtulData(t) {
    t = t || "2017";
    for (var e = +echarts.number.parseDate(t + "-01-01"), a = +echarts.number.parseDate(t + "-12-31"), o = [], r = e; r <= a; r += 864e5) o.push([echarts.format.formatTime("yyyy-MM-dd", r), Math.floor(1e4 * Math.random())]);
    return o
}
chartHeatmapColors && (chartDom = document.getElementById("chart-heatmap"), myChart = echarts.init(chartDom), (option = {
    visualMap: {
        show: !1,
        min: 0,
        max: 1e4
